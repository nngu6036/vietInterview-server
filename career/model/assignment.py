...
class Assignment(models.Model):
    ...
    country_id = fields.Integer('res.country', string="Country ",related='address.country_id')
    province_id = fields.Integer('res.country.state', string="Province ",related='address.state_id')
